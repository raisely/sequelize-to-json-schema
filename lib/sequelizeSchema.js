...
class JsonSchema {
	/**
	  * @param {Object} options.associations Define associations to be inlined
	...
	/**
	  ...
	  */
	selectAttributes() {
		const attributes = this.options.selectAttributes ?
			this.options.selectAttributes(this.model) :
			Object.keys(this.model.attributes);

		if (this.options.associations) {
			attributes.concat(Object.keys(this.options.associations));
		}
